...
const SCRIPT_SECTIONS = [
  ...
  { key: 'storyBody', label: '2. A HistÃ³ria', color: 'text-slate-600 dark:text-white/60', bg: 'bg-slate-100 dark:bg-white/[0.05] border-slate-300 dark:border-white/[0.08]', tag: 'Desenvolvimento' },
  { key: 'lesson', label: '3. LiÃ§Ã£o / ResoluÃ§Ã£o', color: 'text-emerald-400', bg: 'bg-emerald-500/10 border-emerald-500/20', tag: 'ConexÃ£o com objetivo' },
  { key: 'cta', label: '4. CTA', color: 'text-purple-400', bg: 'bg-purple-500/10 border-purple-500/20', tag: 'Chamada para AÃ§Ã£o' },
    ...
    if (content.text || content.visual || content.audio) {
      return (
        <div className="space-y-1">
          ...
          {content.audio && <p className="text-xs opacity-70"><span className="uppercase text-[9px] font-black mr-1">Ãudio:</span> {content.audio}</p>}
        </div>
      );
    }
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-white/40 text-sm font-medium">Transforme histÃ³rias reais em roteiros que conectam e convertem</p>
          </div>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={cn(DARK_CARD, "p-6 space-y-5")}>
          <div>
            <label className={LABEL}>Objetivo do VÃ­deo <span className="text-violet-400">*</span></label>
            <input
              type="text"
              value={objective}
          ...
          <div>
            <label className={LABEL}>A HistÃ³ria <span className="text-violet-400">*</span></label>
            <textarea
              value={story}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className={LABEL}>PÃºblico-Alvo <span className="text-violet-400">*</span></label>
              <input
                type="text"
                value={audience}
          ...
          <div>
            <label className={LABEL}>CTA (Chamada para AÃ§Ã£o) <span className="text-violet-400">*</span></label>
            <input
              type="text"
              value={cta}
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: MÃ¡ximo 60 segundos, tom mais descontraÃ­do..."
              className={DARK_INPUT}
            />
          </div>
